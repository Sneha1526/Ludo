...
function logic(){
  ...
  document.getElementById('name1').innerHTML = 'Sneha score' + score1;
  document.getElementById('name2').innerHTML = 'Pranali score' + score2;

  if(score1>50)
  {
    document.getElementById('name1').innerHTML = 'Sneha won';
    document.getElementById('name2').innerHTML = '';
  }
  if(score2>50)
  {
    document.getElementById('name1').innerHTML = 'Pranali won';
    document.getElementById('name2').innerHTML = '';
  }
}
